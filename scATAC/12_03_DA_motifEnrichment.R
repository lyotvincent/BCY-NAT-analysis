...
PeakCellType <- readRDS("./ArchRProject_endothelial/markersPK_EndothelialSample.rds")
...
plotPDF(p1, name = "Motif_Enrichment_Endothelial.pdf", ArchRProj = proj, addDOC = FALSE, width = 10, height = 15)
