...
markersPK <- readRDS("./ArchRProject_epithelial/markersPK_Epithelial.rds")
...
plotPDF(p1, name = "Epi_cisbp_Motif_Enrichment.pdf", ArchRProj = proj, addDOC = FALSE, width = 10, height = 15)
...
plotPDF(p2, name = "Epi_EncodeTFBS_Enrichment.pdf", ArchRProj = proj, addDOC = FALSE, width = 10, height = 15)

# ==================== 3. bulk ATAC 富集分析 ====================
proj <- addArchRAnnotations(ArchRProj = proj, collection = "ATAC",force = TRUE)
...
plotPDF(p3, name = "Epi_ATAC_Enrichment.pdf", ArchRProj = proj, addDOC = FALSE, width = 10, height = 15)

# ==================== 4. Codex TFBS 富集分析 ====================
proj <- addArchRAnnotations(ArchRProj = proj, collection = "Codex", force = TRUE)
...
plotPDF(p4, name = "Epi_Codex_Enrichment.pdf", ArchRProj = proj, addDOC = FALSE, width = 10, height = 15)
